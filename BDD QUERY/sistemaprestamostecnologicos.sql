...
-- SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '1445d8e8-438f-11f1-9478-dd50f7e69a4f:1-491:1000071-1002712:2000086-2000097,
-- 1445e85d-438f-11f1-9478-dd50f7e69a4f:1-23,
...
INSERT INTO `accesorios` (`cod_accesorio`, `cod_marca`, `nombre_accesorio`) VALUES (1,1,'Cargador Dell 65W Universal'),(2,1,'Mouse Dell MS116 USB'),(3,2,'Cargador HP Punta Azul 45W'),(4,4,'Adaptador Apple USB-C a VGA'),(5,4,'Apple Pencil 2da Generación'),(6,6,'Mouse Inalámbrico Logitech'),(7,7,'Control Remoto Proyector Epson'),(8,8,'Samsung S-Pen Pro'),(9,10,'Batería Sony NP-FZ100'),(10,11,'Microsoft Surface Pen');
...
INSERT INTO `aulas` (`cod_aula`, `nombre_aula`, `cod_edificio`) VALUES (101,'Aula Magna A',1),(102,'Laboratorio de Cómputo 1',2),(103,'Taller de Escultura',3),(104,'Salón de Francés',4),(105,'Sala de Juntas B',5),(106,'Lab. Química Orgánica',6),(107,'Hemeroteca',7),(108,'Aula Virtual 4',8),(109,'Salón de Usos Múltiples',9),(110,'Cabina de Audio',10);
...
INSERT INTO `edificios` (`cod_edificio`, `nombre_edificio`) VALUES (1,'Edificio Central'),(2,'Pabellón de Ingeniería'),(3,'Facultad de Artes'),(4,'Torre de Idiomas'),(5,'Edificio Administrativo'),(6,'Laboratorios de Ciencias'),(7,'Biblioteca Magna'),(8,'Centro de Postgrados'),(9,'Edificio Norte'),(10,'Auditorio Principal');
...
INSERT INTO `estado_equipo` (`cod_estado_equipo`, `tipo_estado_equipo`) VALUES (1,'Activo'),(2,'Inactivo');
...
INSERT INTO `estado_mantenimiento` (`cod_estado_mantenimiento`, `tipo_estado_mantenimiento`) VALUES (1,'Pendiente'),(2,'En Proceso'),(3,'Completado');
...
INSERT INTO `estado_usuario` (`cod_estado_usuario`, `tipo_estado_usuario`) VALUES (1,'Activo'),(2,'Inactivo');
...
INSERT INTO `mantenimientos` (`cod_mantenimiento`, `cod_equipo`, `cod_tipo_mantenimiento`, `cod_usuario`, `cod_estado_mantenimiento`, `fecha_inicio_mantenimiento`, `hora_recibida`, `fecha_fin_mantenimiento`, `Hora_retirada`, `descripcion_problema`) VALUES (1,28,1,22,3,'2026-05-05',NULL,'2026-05-07','23:25:42',NULL),(2,28,2,22,3,'2026-05-05',NULL,'2026-05-09','14:48:01',NULL),(3,28,1,22,3,'2026-05-05','14:45:25','2026-05-08','14:47:58','Se me traba todo y no corre bien google chrome');
...
INSERT INTO `marcas` (`cod_marca`, `nombre_marca`) VALUES (1,'Dell'),(2,'HP'),(3,'Lenovo'),(4,'Apple'),(5,'Asus'),(6,'Logitech'),(7,'Epson'),(8,'Samsung'),(9,'ViewSonic'),(10,'Sony'),(11,'Microsoft'),(12,'Acer'),(13,'Toshiba'),(14,'Huawei'),(15,'Canon'),(16,'Cisco'),(17,'TP-Link'),(18,'Xiaomi'),(19,'BenQ'),(20,'LG');
...
INSERT INTO `prestamos` (`cod_prestamo`, `cod_usuario`, `cod_aula`, `cod_equipo`, `cod_accesorio`, `fecha_salida`, `fecha_devolucion_programada`) VALUES (1,22,108,28,1,'2026-05-05 00:00:00','2026-06-04 00:00:00'),(2,5,108,29,3,'2026-05-05 00:00:00','2026-06-05 00:00:00');
...
INSERT INTO `roles` (`cod_rol`, `nombre_rol`) VALUES (1,'Administrador'),(2,'Director'),(3,'Docente'),(4,'Técnico');
...
INSERT INTO `tipo_mantenimiento` (`cod_tipo_mantenimiento`, `tipo_mantenimiento`) VALUES (1,'Preventivo'),(2,'Correctivo');
...
INSERT INTO `usuarios` (`cod_usuario`, `nombre`, `cod_rol`, `correo`, `contraseña`, `fecha_ingreso`, `cod_estado_usuario`) VALUES (1,'Ricardo Alberto Canales',1,'CR1122012025@unab.edu.sv','1234','2026-04-18',1),(2,'Sonia Margarita Portillo',2,'PS3344022025@unab.edu.sv','12345','2026-04-18',1),(3,'Marcos Aurelio Henríquez',4,'HM5566032025@unab.edu.sv',NULL,'2026-04-18',1),(4,'Elena Patricia Vaquero',3,'VE7788042025@unab.edu.sv',NULL,'2026-04-18',1),(5,'Jorge Alberto Villalobos',3,'VJ9900052025@unab.edu.sv',NULL,'2026-04-18',1),(6,'Claudia Rebeca Menjívar',2,'MC1122062025@unab.edu.sv',NULL,'2026-04-18',1),(7,'Fernando José Batres',3,'BF3344072025@unab.edu.sv',NULL,'2026-04-18',1),(8,'Gabriela María Zelaya',3,'ZG5566082025@unab.edu.sv',NULL,'2026-04-18',1),(9,'Roberto Carlos Alfaro',2,'AR7788092025@unab.edu.sv',NULL,'2026-04-18',1),(10,'Karla Ivette Orellana',3,'OK9900102025@unab.edu.sv',NULL,'2026-04-18',1),(11,'Luis Miguel Cisneros',4,'CL1122112025@unab.edu.sv',NULL,'2026-04-18',1),(12,'Andrea Michelle Solórzano',3,'SA3344122025@unab.edu.sv',NULL,'2026-04-18',1),(13,'Nelson Edgardo Campos',3,'CN5566132025@unab.edu.sv',NULL,'2026-04-18',1),(14,'Tatiana Elizabeth Jovel',2,'JT7788142025@unab.edu.sv',NULL,'2026-04-18',1),(15,'Oscar Armando Meléndez',3,'MO9900152025@unab.edu.sv',NULL,'2026-04-18',1),(16,'Vanessa Alexandra Rivas',3,'RV1122162025@unab.edu.sv',NULL,'2026-04-18',1),(17,'Daniel Ernesto Guzmán',3,'GD3344172025@unab.edu.sv',NULL,'2026-04-18',1),(18,'Monica Beatriz Pineda',3,'PM5566182025@unab.edu.sv',NULL,'2026-04-18',1),(19,'Hugo Alexander Flores',2,'FH7788192025@unab.edu.sv',NULL,'2026-04-18',1),(20,'Rebeca Noemí Castro',3,'CR9900202025@unab.edu.sv',NULL,'2026-04-18',1),(21,'Erick Rafael Ventura Chacón',4,'vc0421012025@unab.edu.sv','Barcelona011*','2026-05-05',1),(22,'Nelly Vanessa Ramírez García',3,'RG1118012025@unab.edu.sv','12345678','2026-05-05',1),(23,'MELISSA RAMIREZ',4,'VANERAMIREZ0909@gmail.com','123456','2026-05-05',1);
...
-- Dump completed on 2026-05-05 21:14:42
